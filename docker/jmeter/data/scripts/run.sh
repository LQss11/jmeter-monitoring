...
JVM_ARGS="-Xms512m -Xmx2048m" jmeter -Jjmeter.save.saveservice.subresults=false -n -t /data/jmx/${scriptname}.jmx -f -l /results/output/$DATE_NOW/${scriptname}.jtl  -e -o /results/output/$DATE_NOW/dashboard -j /results/output/$DATE_NOW/jmeter.log 2>&1
